...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = MyApplicationLike.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MyApplicationLike.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
